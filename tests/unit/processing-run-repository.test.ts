...
import type { ProcessingRunRepository } from '../../src/repositories/interfaces/processing-run-repository.js';
...
describe('ProcessingRunRepository', () => {
  let repo: ProcessingRunRepository;
  let tempDir: string;
  ...
  beforeEach(async () => {
    ...
    repo = connection.repositories.processingRuns;
  });
