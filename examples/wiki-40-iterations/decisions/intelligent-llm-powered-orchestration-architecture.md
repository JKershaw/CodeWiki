...
- [Intelligent Work Orchestration System](commits/fdcf054c.md) - Decision document describes architecture implemented in commit
- [Full Wiki Example: Multi-Agent Documentation System Demonstration](commits/82193f9f.md) - Orchestration architecture coordinates the nine-agent system
- [Meta-Agent Architecture for Wiki Quality Management](commits/addfc9e6.md) - Orchestration coordinates meta-agents including Quality and Consistency