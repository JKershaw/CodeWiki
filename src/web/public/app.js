  ...
  selfImprovementPollingInterval = setInterval(async () => {
    try {
      ...
      if (run.status === 'completed') {
        ...
        // Initialize chat session for Q&A on the report
...
function closeReport() {
  ...
  // Close the chat session when closing the report
  closeChatSession();
}
...
// ============================================================================
// Chat for Self-Improvement Analysis
// ============================================================================
...
async function sendChatMessage() {
  ...
  try {
    ...
    // Update cost display
    chatTotalCost += 0.05; // Approximate, actual cost comes from backend
    updateChatCost();
